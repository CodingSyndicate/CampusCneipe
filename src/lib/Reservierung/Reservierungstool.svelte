<script>
	...
	async function submitReservation() {
		...
		let response = await fetch(`https://www.c2.tum.de/reservierung.php?name=${reservationName}&day=${day}&date=${reservationDate}&time=${reservationTime}&person=${reservationPersons}`, {
			method: 'GET',
